...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mReyclerView = (RecyclerView) findViewById(R.id.recyclerview_forecast);
        ...
        mReyclerView.setAdapter(mForecastAdapter);
    ...
    private void showWeatherDataView() {
        ...
        mReyclerView.setVisibility(View.VISIBLE);
    }
    ...
    private void showErrorMessage() {
        ...
        mReyclerView.setVisibility(View.INVISIBLE);
        /* Then, show the error */
